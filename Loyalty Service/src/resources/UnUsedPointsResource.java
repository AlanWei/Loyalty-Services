 ...
 * @author alanwei
 */
@Path("customers/{customerID}/points/unused")

public class UnUsedPointsResource {

    private CustomerDAO dao = new CustomerDAO();
    private String customerID;
    private Customer customer;

    public UnUsedPointsResource(@PathParam("customerID") String customerID) {
    ...
    public Integer getUnUsedPoints(){
        return this.customer.getUnUsedPoints();
    }
}
